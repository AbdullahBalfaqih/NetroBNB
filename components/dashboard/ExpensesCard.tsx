    ...
    <div className="w-full h-full bg-[#0A0A0A] rounded-xl p-4 shadow-[0_15px_40px_rgba(0,0,0,0.6)] border border-[#1E1E1E] flex flex-col justify-between overflow-hidden text-white">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button className="p-1 text-[#8D8A95] hover:text-white transition-colors cursor-pointer" title="Options">
            <MoreVertical size={16} />
          </button>
          <button className="p-1 text-[#8D8A95] hover:text-white transition-colors cursor-pointer" title="Expand">
      ...
      <div className="grid grid-cols-2 gap-3 my-2">
        ...
        <div className="bg-[#141414] rounded-lg p-3 border border-[#222222] flex flex-col justify-between">
          ...
          <p className="font-sans text-[22px] font-medium text-white mt-2">
            {isWalletConnected ? portfolioData.totalUsd : "--"}
          </p>
        </div>
        ...
        <div className="bg-[#141414] rounded-lg p-3 border border-[#222222] flex flex-col justify-between">
          ...
          <p className="font-sans text-[22px] font-medium text-white mt-2">
            {isWalletConnected ? portfolioData.pnlUsd : "--"}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 pt-1 mt-auto">
        ...
        <div className="w-full flex items-center justify-center select-none pointer-events-none overflow-hidden">
          <img
            ...
            className="w-full h-auto max-h-[68px] object-contain drop-shadow-sm hover:scale-[1.02] transition-transform duration-300"
          />
        </div>
        ...
        <div className="w-full flex items-center justify-center">
          {isWalletConnected ? (
            ...
            <button
              ...
              className="w-full bg-[#F4D014] hover:bg-[#e5c30f] text-[#1C1C1C] font-sans font-bold text-[13.5px] py-2 rounded-lg shadow-[0_4px_20px_rgba(244,208,20,0.2)] border border-yellow-400/30 cursor-pointer transition-all active:scale-95 text-center"
            >
              Connect Wallet
            </button>
          )}
